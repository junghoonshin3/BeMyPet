...
interface AdoptionService {
    ...
    //시도 조회
    suspend fun getSido(sidoRequest: SidoRequest): ApiResult<SidoResponse, CmmErrorResponse>

    //시군구 조회
    suspend fun getSigungu(sigunguRequest: SigunguRequest): ApiResult<SigunguResponse, CmmErrorResponse>

    //보호소 조회
    suspend fun getShelter(shelterRequest: ShelterRequest): ApiResult<ShelterResponse, CmmErrorResponse>

    //품종 조회
    suspend fun getKind(kindRequest: KindRequest): ApiResult<KindResponse, CmmErrorResponse>

    //유기동물 조회
    suspend fun getAbandonmentPublic(abandonmentPublicRequest: AbandonmentPublicRequest): ApiResult<AbandonmentPublicResponse, CmmErrorResponse>
}